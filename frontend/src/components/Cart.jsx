...
const selectitem=(pid)=>{
                  ...
                  // Ensure only the first two items are displayed
                   return<>
                     ...
                     <div className="cart-item"><p><strong>{index + 1}</strong></p></div>
                       ...
                       <div className="cart-item"><h3>Rs. {item.price}</h3></div>
                     </div>
                   </>
               })}
               </div>
  ...
  <div className="cart-total">
    <h2><br/>
      Total&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Rs.{" "}
      {product.filter((item) => item.isSwapdisplay === false).reduce((total, item) => total + Number(item.price), 0)}
    </h2>
  </div>
                  ...
                  // Ensure only the first two items are displayed
                   return<>
                     ...
                     <div><p><strong>{index + 1}</strong></p></div>
                       ...
                       <div><button onClick={()=>selectitem(item._id)}>Select your item for swap and trade</button></div>
                     </div>
                   </>
               })}
               </div>
