...
function EditProduct(){
    ...
    const handleApi=()=>{
        const url='http://localhost:8000/edit-product';
        console.log(image);
    ...
    const deleteItem=(id)=>{
        console.log(id);
        const url='http://localhost:8000/delete-product';
    ...
    return <>
        ...
        <button onClick ={handleApi} className="btn btn-primary mt-3">EDIT</button>
        <button onClick={()=>{deleteItem(p.productid)}} className="btn btn-primary mt-3">DELETE</button>
        </div>   
        </div>     
